# feat: Implement interactive 3D donut using Three.js
To run this 3D donut visualization, you'll need to serve the files using a local web server. Most modern browsers restrict loading JavaScript modules (like OrbitControls.js and script.js in our case) directly from the local file system (file:///...) due to security reasons.
